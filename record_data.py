...
FOLLOWER_PORT = "/dev/ttyACM1" # Use correct follower port
LEADER_PORT = "/dev/ttyACM0" # Use correct leader port
...
def main():
    ...
    camera_config = {"wrist": OpenCVCameraConfig(index_or_path=WRIST_CAMERA_PATH, width=640, height=480, fps=FPS, fourcc="MJPG")}
